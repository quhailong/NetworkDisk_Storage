...
function ajax() {
    var a = $(this).data("key");
    if (a == "all") {
        location.href = "http://localhost:8097/disk/home" + "#/" + a + "?path=/"
    } else {
        if (a == "myShare") {
            location.href = "http://localhost:8097/share/manage"
        } else {
            location.href = "http://localhost:8097/disk/home" + "#/" + a
        }
    }
}
...
function loadContent() {
    ...
    $.ajax({
        url: "http://localhost:8095/api/share/sharelist",
        type: "get",
...
function unShare(a) {
    $.ajax({
        url: "http://localhost:8095/api/share/unshare",
        type: "get",

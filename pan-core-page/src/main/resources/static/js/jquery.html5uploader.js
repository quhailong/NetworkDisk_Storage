						  ...
						  function get_filemd5sum(ofile,ofid,xhr1) {
							  ...
							  if(file.size<2097152000){
								  fileReader.onload = function(e) {
									  ...
									  fileReader.abort();
									  $.ajax({
										  url : "http://localhost:8096/api/file/md5check",
										  type : "get",
										  ...
										  success : function(data) {
											 // alert(data)
											  if (data.respCode==1) {
												  $.ajax({
													  url : "http://localhost:8096/api/file/quickuploadfile",
													  type : "post",
													  data : {"uid":$.cookie('uid'),"md5":tmp_md5,"fileName":file.name,"fid":fid,"parentPath":parentPath},
													  xhrFields : {
														  withCredentials : true
													  },
													  crossDomain : true,

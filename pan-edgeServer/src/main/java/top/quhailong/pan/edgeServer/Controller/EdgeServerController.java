...
import top.quhailong.pan.edgeServer.utils.MyRedisTemplate;
...
public class EdgeServerController {
	...
	public RestAPIResult<String> getKey() throws Exception {
	...
	public String getVerfyImg(@PathVariable(value = "vcodestr") String vcodestr, HttpServletResponse response) {
		int width = 120;
		int height = 30;
		...
		// 将生成的字母存入到session中
		redisTemplate.setWithExpireTime("verfiyCode", vcodestr, sb.toString(), 600);
		// 步骤五 绘制干扰线
	...
	public RestAPIResult<String> checkpwd(@RequestParam("password") String password,@RequestParam("RSAKey") String RSAKey){
